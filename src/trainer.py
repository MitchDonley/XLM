...
class Trainer(object):
    ...
    def clm_step(self, lang1, lang2, lambda_coeff):
        ...
        _, loss = model('predict', tensor=tensor, langs=(lang1,lang2), pred_mask=pred_mask, y=y, get_scores=False)
    ...
    def mlm_step(self, lang1, lang2, lambda_coeff):
        ...
        _, loss = model('predict', tensor=tensor, positions=positions, langs=(lang1,lang2), pred_mask=pred_mask, y=y, get_scores=False)
